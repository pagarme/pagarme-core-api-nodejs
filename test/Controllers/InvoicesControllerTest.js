...
const GetInvoiceResponse = testerlib.GetInvoiceResponse;
const CreateInvoiceRequest = testerlib.CreateInvoiceRequest;
const UpdateMetadataRequest = testerlib.UpdateMetadataRequest;
const ListInvoicesResponse = testerlib.ListInvoicesResponse;
const UpdateInvoiceStatusRequest = testerlib.UpdateInvoiceStatusRequest;
