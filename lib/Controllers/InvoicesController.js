...
class InvoicesController {
     ...
     * @param {string} idempotencyKey (optional) TODO: type description here
     * @param {CreateInvoiceRequest} body (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createInvoice(subscriptionId, cycleId, idempotencyKey, body, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @param {UpdateMetadataRequest} body Request for updating the invoice metadata
     * @param {string} idempotencyKey (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateInvoiceMetadata(invoiceId, body, idempotencyKey, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     *
     * @param {string} invoiceId Invoice Id
     * @param {UpdateInvoiceStatusRequest} body Request for updating an invoice's status
     * @param {string} idempotencyKey (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static updateInvoiceStatus(invoiceId, body, idempotencyKey, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
